...
> 1.2.x 系列 = **1.2.0 正式版**（dev.1 ~ dev.12 + pre.1/pre.2，2026-08-17 发布 ✅）+ **1.2.1 补丁**（按项目类型差异化模板生成，✅ 2026-08-18 发布，tag `v1.2.1`）+ **1.2.2 补丁**（教程分类重组，✅ 2026-08-18 完成）+ **1.2.3 补丁**（`ezmk example` 命令组，✅ 2026-08-18 完成）+ **1.2.4 补丁**（仓库文件夹包支持，✅ 2026-08-18 完成）。
>
