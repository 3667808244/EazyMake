...
| 版本 | 主题 | 关键交付 | 状态 |
|------|------|----------|------|
| [1.2.4](1.2.4.md) | 仓库文件夹包支持 | 按名安装目录分支（复用 dev.7 install_from_directory）+ index `type = "dir"` 标注 + sha256 语义区分 + 集成测试（local 仓库目录包端到端）/归档回归 + 文档 | **已完成**（2026-08-18，全量 793/3755 零回归） |
