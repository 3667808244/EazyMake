...
>
> 本目录为 1.4.x 全部文档的**平铺结构**（无子文件夹）：`1.4.0-dev.N.md` 为开发子版本，`1.4.0-pre.N.md` 为发布前收口（`1.4.0-pre.1.md` 已建），`1.4.0.md` 为正式版聚合（届时新建），`1.4.1.md` / `1.4.2.md` 为正式发布后的补丁版本（对照 1.3.x 补丁惯例）。
...
1.4.0-pre.1 (收口) ──→ 1.4.0 (正式发布, 2026-08-30) ──→ 1.4.1 (git URL 安装, 已发布 2026-09-03) ──→ 1.4.2 (代码质量审计修复第二轮, 已发布 2026-09-13 / tag `v1.4.2`)
```
...
- **回归基线**：全量 1020 用例 / 5970 断言（1.4.1 发布态实测）；1.4.2 开发完成后为 1099/6342，新增功能不得引入回归。
