...
1.4.0-pre.1 (收口) ──→ 1.4.0 (正式发布, 2026-08-30) ──→ 1.4.1 (git URL 安装, 已发布 2026-09-03) ──→ 1.4.2 (代码质量审计修复第二轮, 已发布 2026-09-13 / tag `v1.4.2`) ──→ 1.4.3 (man 手册 4 页, 已发布 2026-09-19 / tag `v1.4.3`) ──→ 1.4.4 (历史遗留清理, 已发布 2026-09-26 / tag `v1.4.4`)
```
