...
| 0.9.6 | 功能补全     | 依赖版本锁定(`foo@1.2.3`/`^1.0`/`~1.2`/`>=1.0`),构建进度显示(逐文件 `[N/M]`),`.clang-format` 基础设施,ASCII Logo                                            | 0.9.5(集成测试就绪)                             |
...
graph TD
    ...
    class v016,v017,v018,v020,v021,v022,v023,v024,v025,v026,v090,v091,v092,v093,v094,v095 done;
    class v096 active;
    class v097,v098,v099,v100 todo;
```
