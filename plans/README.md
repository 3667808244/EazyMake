...
| 1.0.0 | 首个稳定版   | 版本号终局化、CHANGES.md 补全、三平台冒烟 + i18n 审计、GitHub Release + 签名 tag、CLI/ezmk.toml 稳定承诺                                         | 0.9.3(捆绑包迁移完成)                           |
...
graph TD
    ...
    class v016,v017,v018,v020,v021,v022,v023,v024,v025,v026,v090,v091,v092 done;
    class v093 active;
    class v100 todo;
```

> 说明:`0.1.6`(测试)独立,可随时开始;`0.1.7`(i18n)与 `0.1.8`(跨平台)彼此独立。绿色=已完成,黄色=当前执行,灰色=待执行;虚线为可选依赖。
