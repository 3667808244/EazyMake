...
> 仓库根目录的 `plan.md` 为当前执行计划。**1.1.3 已发布**（2026-08-10，承接 1.1.2 未单独发布的修复）；当前推进 **1.2.0**。

---

## 当前执行

- **[1.2.0](1.2.0/README.md)** — 工具链互操作与开箱工程化（`ezmk project cc` / CMakeLists.txt 导出 / 默认模板 Profile）
