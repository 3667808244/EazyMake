...
├── 1.2.0/          # 1.2.0 发布系列（dev.1 ~ dev.12 + pre.1/pre.2 + 1.2.0）
│   ├── README.md
│   └── 1.2.0-dev.N.md / 1.2.0-pre.N.md / 1.2.0.md
└── 1.2.x/          # 1.2.x 补丁系列（1.2.1）
    ├── README.md
    └── 1.2.1.md
```
...
- **[1.2.0](1.2.0/README.md)** — 工具链互操作与开箱工程化（`ezmk project cc` / CMakeLists.txt 导出 / 默认模板 Profile / 高级特性触达 / pacman 分发），2026-08-17 已发布 ✅
...
| 1.2.x | 1.2.0 补丁系列 | 1.2.1 按项目类型差异化模板生成（库骨架 .hpp/.cpp） | [1.2.x/README.md](1.2.x/README.md) |
