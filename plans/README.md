...
> 仓库根目录的 `plan.md` 为当前执行计划。**1.2.0 已于 2026-08-17 正式发布**（tag `v1.2.0`）、**1.2.1 已于 2026-08-18 发布**（tag `v1.2.1`）、**1.2.4 已于 2026-08-18 发布**（tag `v1.2.4`）；**1.2.2（教程分类重组）、1.2.3（`ezmk example` 命令组）已完成并打 tag（未单独发 Release，随 1.2.4 聚合）**。下一个版本窗口 **2.0.0**（破坏性变更）。

---

## 当前执行

- *（1.2.x 补丁系列 1.2.1~1.2.4 全部完成；下一版本窗口见「未来规划」）*
