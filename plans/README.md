...
> 仓库根目录的 `plan.md` 为当前执行计划。**1.2.0 已于 2026-08-17 正式发布**（tag `v1.2.0`）、**1.2.1 已于 2026-08-18 发布**（tag `v1.2.1`）；**1.2.2（教程分类重组）与 1.2.3（`ezmk example` 命令组）已于 2026-08-18 完成**。下一个版本窗口 **2.0.0**（破坏性变更）。

---

## 当前执行

- **[1.2.4](1.2.x/1.2.4.md)** — 仓库文件夹包支持（`pkg install` 按名安装解析出目录时复用文件夹安装；`index.toml` 增可选 `type = "dir"` 标注）——规划中，待启动
...
- **[1.2.x](1.2.x/README.md)** — 正式版 + 补丁发布系列（1.2.0 工具链互操作与开箱工程化 2026-08-17 已发布 ✅；1.2.1 模板差异化 2026-08-18 已发布 ✅；1.2.2 教程分类重组 2026-08-18 已完成 ✅；1.2.3 `ezmk example` 命令组 2026-08-18 已完成 ✅）
