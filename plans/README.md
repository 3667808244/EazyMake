...
> 仓库根目录的 `plan.md` 为当前执行计划。**1.2.0 已于 2026-08-17 正式发布**（tag `v1.2.0`）、**1.2.1 已于 2026-08-18 发布**（tag `v1.2.1`）；当前推进 **1.2.2**（教程分类重组，文档补丁）。下一个版本窗口 **2.0.0**（破坏性变更）。

---

## 当前执行

- **[1.2.2](1.2.x/1.2.2.md)** — 教程分类重组（教程 14 章移入 `basic/` 入门 · `packages/` 包管理 · `dev/` 开发体验 · `interop/` 工具链互操作四分类子目录 + 组内重新编号 + README 分组索引 + 全仓链接修复）
...
- **[1.2.x](1.2.x/README.md)** — 正式版 + 补丁发布系列（1.2.0 工具链互操作与开箱工程化 2026-08-17 已发布 ✅；1.2.1 模板差异化 2026-08-18 已发布 ✅；1.2.2 教程分类重组进行中）
