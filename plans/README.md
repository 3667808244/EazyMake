...
└── 1.2.0/          # 1.2.0 发布系列（dev.1 ~ dev.4 + 1.2.0）
    ├── README.md
    └── 1.2.0-dev.N.md / 1.2.0.md
```

> 仓库根目录的 `plan.md` 为当前执行计划。**1.2.0 已于 2026-08-17 正式发布**（tag `v1.2.0`，聚合 dev.1 ~ dev.12 + pre.1/pre.2）。下一个版本窗口 **2.0.0**（破坏性变更）。

---

## 当前执行

- （1.2.0 已发布，无在执行版本；2.0.0 规划中）
