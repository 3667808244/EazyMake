...
> 仓库根目录的 `plan.md` 为当前执行计划。**1.2.0 已于 2026-08-17 正式发布**（tag `v1.2.0`）、**1.2.1 已于 2026-08-18 发布**（tag `v1.2.1`）；**1.2.2（教程分类重组）、1.2.3（`ezmk example` 命令组）、1.2.4（仓库文件夹包支持）已于 2026-08-18 完成**。下一个版本窗口 **2.0.0**（破坏性变更）。
...
- **[1.2.x](1.2.x/README.md)** — 正式版 + 补丁发布系列（1.2.0 工具链互操作与开箱工程化 2026-08-17 已发布 ✅；1.2.1 模板差异化 2026-08-18 已发布 ✅；1.2.2 教程分类重组 / 1.2.3 `ezmk example` 命令组 / 1.2.4 仓库文件夹包支持 2026-08-18 全部完成 ✅）
