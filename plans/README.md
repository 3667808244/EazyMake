...
- **[1.0.0](release/1.0.0.md)** - 正式版发布:plans 目录整理（dev/release 拆分）、`docs/zh/cli.md` 全中文翻译、11 项文档审计（pkg.md 仓库声明修复等）、核心文档重写（CLAUDE/README）、Git tag 补全（v0.1.7, v0.9.8, v0.9.9）
...
- 详细 Gate 定义见 `plans/release/1.1.0-pre.3.md`「⛔ 发布门槛」
