...
> 1.1.0 系列：dev.1 ~ dev.7（包编译与开发体验）+ pre.1（改善用户触达）+ pre.2（文档检查）+ pre.3（缺陷收集与未实现项补全），合并为 1.1.0 正式版。**1.1.0 已于 2026-08-07 正式发布 ✅**（`v1.1.0` GitHub Release + Homebrew tap；macos-x64 / winget 为发布后跟进项）。
