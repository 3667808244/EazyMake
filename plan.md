...
>
> **版本决策**：dev 阶段二进制版本号保持 1.4.1（1.2.x/1.3.x/1.4.1 补丁先例不提前 bump），正式发布 commit 按 workflow §3 置 1.4.2（已执行：`build.sh` fallback + `include/ezmk/version.hpp` = 1.4.2，tag `v1.4.2` 已推送）。
>
