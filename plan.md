...
>
> **⛔ 发布门槛**：① 计划清单全部完成或明确收口；② 公共 API 无破坏性变更；③ 全量测试零回归（基线 836 用例 / 4126 断言，1.3.0-dev.2 后）。
...
- [ ] **3.4 全量回归**：`bash build.sh test-all` 零失败（基线 836/4126 + workspace 用例）
...
- [ ] **4.7 收口**：全量回归（dev.2 基线 836/4126 零回归）
...
- [ ] **5.5 收口**：全量回归（dev.2 基线 836/4126 零回归）
