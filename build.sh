...
EZMK_VERSION="${EZMK_VERSION:-0.2.3}"
...
TEST_SRC="src/build.cpp src/cache.cpp src/cli.cpp src/config.cpp src/crypto.cpp src/file_watcher.cpp src/i18n.cpp src/lua_api.cpp src/pkg.cpp src/project.cpp src/repo.cpp src/toolchain.cpp src/util.cpp src/vendor/*.c src/vendor/catch2_impl.cpp src/vendor/lua/*.c"
